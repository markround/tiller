# 1.x
  ...
  * 1.1.0 (unreleased)
    ...
    * Fixed [Issue #54](https://github.com/markround/tiller/issues/54). Many thanks to [Bob Saveland](https://github.com/savelandr) for the bug report, and for providing the fix and test cases.
